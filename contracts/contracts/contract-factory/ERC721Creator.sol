    ...
    contract ERC721Creator is Initializable, AdminControl, ERC721Upgradeable, Core {
        ...
        */
        ...
        function mintToken(
            ...
            if (receivers.length > 0 ) {
                ...
                setRoyaltiesInternal(newTokenId, _defaultReceivers, _defaultRoyalty);
            }
        ...
        */
        function setRoyalties(
            ...
            require(receivers.length > 0, "No definition given");

            _defaultRoyalty = basisPoints;
            _defaultReceivers = receivers;
        }
        ...
        * @dev See {ICreatorCore-setRoyalties}.
        */
        function setRoyaltiesInternal(
            uint256 tokenId,
            address payable[] memory receivers,
            uint256[] memory basisPoints
        ) public adminRequired {
            require(_exists(tokenId), "Nonexistent token");
            _setRoyaltiesInternal(tokenId, receivers, basisPoints);
        }
